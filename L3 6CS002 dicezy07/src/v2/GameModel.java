...
public class GameModel {
	...
	private int gameStrategy(int[] scoreCard, int goesLeft, int chosenGameType) {
		...
		case 0: { // roll manually
			...
			manualRollStrategy(dice, rerollInput);
		}
			break;
		case 1: // random plod away
			autoPlodStrategy(scoreCard, dice);
			break;
		...
		printScoreAsChoices(scoreCard, chosenGameType);
		...
		while (!scoreChosen) {
			...
			scoreChosen = scoring(scoreCard, chosenGameType, dice, scoreChosen,
					scoreChoice);
	...
	public boolean scoring(int[] scoreCard, int chosenGameType, int[] dice,
	...
	public void printScoreAsChoices(int[] scoreCard, int chosenGameType) {
	...
	public void autoPlodStrategy(int[] scoreCard, int[] dice) {
