...
public class Q6_TCP_HTTPexchange {
  ...
  public static void main(String[] args) throws IOException {
    ...
    XMLLogger logWithXML = new XMLLogger("xmllog");

    String timeText = new SimpleDateFormat("EEE, dd MM yyyy HH:mm:ss")
        .format(new Date().getTime());
    logWithXML.log(XMLLogger.Tag.INFO, "Date/Time: " + timeText);

    logWithXML.log(XMLLogger.Tag.RECIEVED, message);
    // System.out.println("Recieved from BufferedReader: " + message);
    ...
    logWithXML.log(XMLLogger.Tag.REQUESTED, getThis);
    ...
    try {
      ...
      logWithXML.log(XMLLogger.Tag.RESPONSE, responseHeader);
      responseHeader += "\n\n";
      ...
      logWithXML.log(XMLLogger.Tag.OUTPUT, getThisWithDoubleSlashes
          + " Found and Output.");
      os.flush();
      logWithXML.log(XMLLogger.Tag.INFO, "Exchange Complete - Successful");
    } catch (Exception e) {
      // log error 404 occurrence
      logWithXML.log(XMLLogger.Tag.ERROR,
          "Error Finding Requested Page, returning error 404.");
      // output error 404
      // get error 404 page
      ...
      os.write(responseInBytes, 0, responseInBytes.length);
      logWithXML.log(XMLLogger.Tag.OUTPUT, "Error 404 output.");
      os.flush();
      logWithXML.log(XMLLogger.Tag.INFO, "Exchange Complete - Unsuccessful");
    }

    // end XML logging
    logWithXML.endDocument();
