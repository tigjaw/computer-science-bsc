...
public class AskyDood {
  ...
  OrientationStrategy west = new WestOrientation();

  OrientationStrategy east = new EastOrientation();
  ...
  public void load() {
    try {
      ...
      if (line.equals("WEST")) {
        currentOrientation = new WestOrientation();
      }
      if (line.equals("EAST")) {
        currentOrientation = new EastOrientation();
      }
  ...
  public class WestOrientation extends OrientationStrategy {
    void moveForward() {
      if (penColumn > 0) {
        penColumn--;
      }
  ...
  public class EastOrientation extends OrientationStrategy {
    void moveForward() {
